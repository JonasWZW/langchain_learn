...
# <class 'dict'>
# {'messages': [
# HumanMessage(content='外面的天气怎么样？', additional_kwargs={}, response_metadata={}, id='7f937ad2-1d05-4455-95c4-249eebd71aaf'),
# AIMessage(content='', additional_kwargs={'refusal': None}, response_metadata={'token_usage': {'completion_tokens': 13, 'prompt_tokens': 276, 'total_tokens': 289, 'completion_tokens_details': {'accepted_prediction_tokens': None, 'audio_tokens': None, 'reasoning_tokens': 0, 'rejected_prediction_tokens': None}, 'prompt_tokens_details': None}, 'model_provider': 'openai', 'model_name': 'deepseek-ai/DeepSeek-V3', 'system_fingerprint': '', 'id': '019a881505575f2c26ca13c28739a64f', 'finish_reason': 'tool_calls', 'logprobs': None}, id='lc_run--bda2fc0e-6008-40d9-b268-5a459bd50a7c-0', tool_calls=[{'name': 'get_user_location', 'args': {}, 'id': '019a88150ac0defceba312eb3dfea8a8', 'type': 'tool_call'}], usage_metadata={'input_tokens': 276, 'output_tokens': 13, 'total_tokens': 289, 'input_token_details': {}, 'output_token_details': {'reasoning': 0}}),
# ToolMessage(content='wuhan', name='get_user_location', id='9183e0dd-dabd-4afc-b25e-be1664fe0fe5', tool_call_id='019a88150ac0defceba312eb3dfea8a8'),
...
# ToolMessage(content='sunny', name='get_weather', id='3e1d6ae5-ae74-48f2-a691-05beb2d97a87', tool_call_id='019a881516b4403148203013c83d71e9'),
# AIMessage(content='', additional_kwargs={'refusal': None}, response_metadata={'token_usage': {'completion_tokens': 29, 'prompt_tokens': 330, 'total_tokens': 359, 'completion_tokens_details': {'accepted_prediction_tokens': None, 'audio_tokens': None, 'reasoning_tokens': 0, 'rejected_prediction_tokens': None}, 'prompt_tokens_details': None}, 'model_provider': 'openai', 'model_name': 'deepseek-ai/DeepSeek-V3', 'system_fingerprint': '', 'id': '019a881516ed6bd91d0f509700ef626b', 'finish_reason': 'tool_calls', 'logprobs': None}, id='lc_run--734c81f1-bafc-4e1b-a5f2-4d8c526c80c0-0', tool_calls=[{'name': 'MyResponse', 'args': {'user_name': 'user', 'user_location': 'wuhan', 'weather_condition': 'sunny'}, 'id': '019a881521221f51fdafe74acbbfbd81', 'type': 'tool_call'}], usage_metadata={'input_tokens': 330, 'output_tokens': 29, 'total_tokens': 359, 'input_token_details': {}, 'output_token_details': {'reasoning': 0}}),
...
#MyResponse(user_name='User', user_location='wuhan', weather_condition='sunny')
